...
<html>
  ...
  <tr>
    ...
    <th>Contraseña</th>
        ...
        <td><td><a class="btn btn-success btn-block" href="formularioUsuario.jsp"  method="POST" >Modificar </a></td></td>
        <td><a class="btn btn-success btn-block" href="formularioUsuario.jsp"  method="POST" >Eliminar </a></td>       
            </tr>
            <%}%>
            </body>
